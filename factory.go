...
func createTracesExporter(
	...
	return exporterhelper.NewTracesExporter(
		...
		set,
		cfg,
		fe.Unwrap().(*// Copyright The OpenTelemetry Authors
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
// You may obtain a copy of the License at
...
func createTracesExporter(
	...
	return exporterhelper.NewTracesExporter(
		...
		set,
		cfg,
		fe.Unwrap().(*enmsAnalyticsExporter).ConsumeTraces,
...
func createMetricsExporter(
	...
	return exporterhelper.NewMetricsExporter(
		...
		set,
		cfg,
		fe.Unwrap().(*enmsAnalyticsExporter).ConsumeMetrics,
		exporterhelper.WithStart(fe.Start),
		exporterhelper.WithShutdown(fe.Shutdown),
	)
}
...
func createLogsExporter(
	...
	return exporterhelper.NewLogsExporter(
		...
		set,
		cfg,
		fe.Unwrap().(*enmsAnalyticsExporter).ConsumeLogs,
		exporterhelper.WithStart(fe.Start),
		exporterhelper.WithShutdown(fe.Shutdown),
	)
}

func newFileExporter(conf *Config, writer io.WriteCloser) *enmsAnalyticsExporter {
	return &enmsAnalyticsExporter{
		path:             conf.Path,
